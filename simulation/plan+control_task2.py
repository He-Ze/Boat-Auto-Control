...
def change_motor():
    ...
    if not had_arrive_the_dis:
        ...
        speed = 0
    if decide_angle < 0:
        w = math.sqrt(-decide_angle / math.pi) * 2
    else:
        w = math.sqrt(decide_angle / math.pi) * 2
...
def plot_ponit():
    ...
    while True:
        ...
        plt.clf()
        plt.axis('equal')
        #plt.xlim(boat[0]-20, boat[0] +20)
        #plt.ylim(boat[1] - 20, boat[1] +20)
        plt.xlabel(boat[0])
        plt.ylabel(boat[1])
        plt.title(goal_num)
        #plt.plot([20, 20, 150, 280, 280], [20, 280, 150, 280, 20], color='g')
        plt.plot([60, 110,160], [20,20,20], "bo")
        ...
        plt.plot([des[goal_num][0]],[des[goal_num][1]],'ro')
        x.append(boat[0])
        y.append(boat[1])
        plt.plot(x,y, 'b.')
...
if __name__ == '__main__':
    ...
    destination = [210, 20]
    des = [[10,20,0],[60, 30, 0], [110, 30, 0], [120, 25, math.pi],[120, 20, math.pi],[115, 15, math.pi], [110, 10, math.pi],[100, 15, -2*math.pi/3],[100, 20, math.pi],[120, 27, -math.pi/3],[160, 10, 0],[210,20,0]]
